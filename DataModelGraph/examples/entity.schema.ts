...
export class Convert {
    public static toEntity(json: string): Entity {
        return cast(JSON.parse(json), r("Entity"));
    }

    public static entityToJson(value: Entity): string {
        return JSON.stringify(uncast(value, r("Entity")), null, 2);
    }
}
...
const typeMap: any = {
    ...
    "Property": o([
        ...
        { json: "property_id", js: "property_id", typ: "" },
        { json: "sync_to", js: "sync_to", typ: u(undefined, a("")) },
        { json: "synced_from", js: "synced_from", typ: u(null, "") },
